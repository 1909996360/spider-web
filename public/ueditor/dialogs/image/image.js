...
(function () {
    ...
    RemoteImage.prototype = {
        ...
        initContainer: function () {
            ...
            if (img&&!img.getAttribute("source-src")) {
                this.setImage(img);
            }
        },
        initEvents: function () {
        ...
        setImage: function(img){
            ...
            if(src) {
                /* 设置表单内容 */
                //console.log(domUtils.getStyle(img, 'width'));
                if(img.getAttribute("width")=="100%"||domUtils.getStyle(img, 'width')=="100%"){
                    $G("autowidth").checked=true;
        ...
        getInsertList: function () {
            ...
            var auto=$G('autowidth').checked;
            var w=data['width']!=null && data['width']!=''?data['width']+"px":"auto";
            var h=data['height']!=null && data['height']!=''?data['height']+"px":"auto";
            if(auto){
                w="100%";
                h="auto";
            }
